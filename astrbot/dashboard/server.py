...
from .routes.chat_analytics import ChatAnalyticsRoute
from .routes.content_sop_ops import ContentSopOpsRoute
from .routes.employee_insight import EmployeeInsightRoute
from .routes.harness_loop import HarnessLoopRoute
from .routes.memory_governance import MemoryGovernanceRoute
from .routes.pet_live import PetLiveRoute
from .routes.route import RouteContext
from .routes.workspace import WorkspaceRoute
...
def _resolve_dashboard_static_path(
    webui_dir: str | None,
    bundled_dist: Path | None = None,
) -> Path:
    bundled_dist = bundled_dist or get_bundled_dashboard_dist_path()
