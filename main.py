...
from astrbot.dashboard.quick_entries import (
    install_dashboard_quick_entries,  # noqa: E402
)
...
async def main_async(webui_dir_arg: str | None) -> None:
    ...
    if webui_dir is None:
        ...
        quick_entries_result = install_dashboard_quick_entries(webui_dir)
        for message in quick_entries_result.messages:
            if quick_entries_result.ok:
                logger.info(message)
            else:
