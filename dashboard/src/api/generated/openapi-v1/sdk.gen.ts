...
/**
 * Get NAS media provider OAuth status
 */
export const getMediaAuthStatus = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetMediaAuthStatusResponse, GetMediaAuthStatusError, ThrowOnError>({
        ...options,
        url: '/api/v1/media-auth/status'
    });
};

/**
 * Start a NAS media provider OAuth Device Flow
 */
export const startMediaAuthLogin = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<StartMediaAuthLoginData, ThrowOnError>) => {
    return (options?.client ?? client).post<StartMediaAuthLoginResponse, StartMediaAuthLoginError, ThrowOnError>({
        ...options,
        url: '/api/v1/media-auth/{provider}/login/start'
    });
};

/**
 * Poll a NAS media provider OAuth Device Flow
 */
export const checkMediaAuthLogin = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CheckMediaAuthLoginData, ThrowOnError>) => {
    return (options?.client ?? client).post<CheckMediaAuthLoginResponse, CheckMediaAuthLoginError, ThrowOnError>({
        ...options,
        url: '/api/v1/media-auth/{provider}/login/check'
    });
};

/**
 * Test NAS media provider authentication
 */
export const testMediaAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<TestMediaAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<TestMediaAuthResponse, TestMediaAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/media-auth/{provider}/test'
    });
};

/**
 * Clear NAS media provider authentication
 */
export const logoutMediaAuth = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<LogoutMediaAuthData, ThrowOnError>) => {
    return (options?.client ?? client).post<LogoutMediaAuthResponse, LogoutMediaAuthError, ThrowOnError>({
        ...options,
        url: '/api/v1/media-auth/{provider}/logout'
    });
};
