...
class RuleMatch:
    ...
    reason: str
    source: str
    confidence: str | None = None  # only set when source == "classifier"
...
PREFIX_RULES: tuple[tuple[str, RouterIntent, str], ...] = (
    ...
    ("#实时", RouterIntent.REALTIME, "User forced realtime routing."),
    ("#realtime", RouterIntent.REALTIME, "User forced realtime routing."),
    ("#快速", RouterIntent.CASUAL, "User forced casual/fast routing."),
    ("#fast", RouterIntent.CASUAL, "User forced casual/fast routing."),
    ("#写作", RouterIntent.OPS_WRITING, "User forced writing routing."),
    ("#writing", RouterIntent.OPS_WRITING, "User forced writing routing."),
    ("#codex", RouterIntent.SIMPLE_CODE, "User forced Codex routing by prefix."),
    ("#codex高", RouterIntent.SIMPLE_CODE, "User forced Codex routing by prefix."),
    ("#codex超深", RouterIntent.SIMPLE_CODE, "User forced Codex routing by prefix."),
)
