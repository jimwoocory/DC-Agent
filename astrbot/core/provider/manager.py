...
class ProviderManager:
    ...
    def dynamic_import_provider(self, type: str) -> None:
        ...
        match type:
            ...
            case "codex_oauth_chat":
                from .sources.codex_oauth_source import (
                    ProviderCodexOAuth as ProviderCodexOAuth,
                )
            case "gemini_oauth_chat":
                from .sources.gemini_oauth_source import (
                    ProviderGeminiOAuth as ProviderGeminiOAuth,
                )
